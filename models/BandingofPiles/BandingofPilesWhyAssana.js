...
const BandingofPilesWhyAssanaSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.BandingofPilesWhyAssana ||
  mongoose.model("BandingofPilesWhyAssana", BandingofPilesWhyAssanaSchema);
