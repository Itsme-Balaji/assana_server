...
const LaserSurgeryWhyAssanaSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.LaserSurgeryWhyAssana ||
  mongoose.model("LaserSurgeryWhyAssana", LaserSurgeryWhyAssanaSchema);
