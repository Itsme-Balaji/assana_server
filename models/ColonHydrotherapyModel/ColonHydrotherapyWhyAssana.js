...
const ColonHydrotherapyWhyAssanaSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.ColonHydrotherapyWhyAssana ||
  mongoose.model("ColonHydrotherapyWhyAssana", ColonHydrotherapyWhyAssanaSchema);
