...
const PelvicFloorWhyAssanaSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.PelvicFloorWhyAssana ||
  mongoose.model("PelvicFloorWhyAssana", PelvicFloorWhyAssanaSchema);
