...
const ColorectalSymptomsSchema = new mongoose.Schema(
  {
    ...
    needToKnow5HelpHeading:String,
    needToKnow5HelpPara:String,
    needToKnow5SymptomsHeading:String,
    needToKnow5SymptomsPara1:String,
    needToKnow5SymptomsPara2:String,
    needToKnow5SymptomsPara3:String,

    needToKnow6Heading:String,
    needToKnow6WhatisHeading:String,
    needToKnow6WhatisPara:String,
    needToKnow6HelpHeading:String,
    needToKnow6HelpPara:String,
    needToKnow6SymptomsHeading:String,
    needToKnow6SymptomsPara1:String,
    needToKnow6SymptomsPara2:String,
    needToKnow6SymptomsPara3:String,
...
module.exports =
  mongoose.models.ColorectalSymptoms ||
  mongoose.model("ColorectalSymptoms", ColorectalSymptomsSchema);
