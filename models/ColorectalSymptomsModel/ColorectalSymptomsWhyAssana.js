...
const ColorectalSymptomsWhyAssanaSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.ColorectalSymptomsWhyAssana ||
  mongoose.model("ColorectalSymptomsWhyAssana", ColorectalSymptomsWhyAssanaSchema);
