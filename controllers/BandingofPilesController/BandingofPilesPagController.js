...
const bandingofPilesPageModel = require("../../models/BandingofPiles/BandingofPilesPageModel");
...
router.post(
  ...
  async (req, res) => {
    try {
      let existingDoc = await bandingofPilesPageModel.findOne();

      const bandingofPilesPageData = { ...req.body };
...
router.get("/dataGet", async (req, res) => {
  try {
    ...
    const data = await bandingofPilesPageModel.findOne().select(
